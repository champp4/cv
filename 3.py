...
cv2.namedWindow("Resizable 3D Image", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Resizable 3D Image", 400, 400)

# Create a trackbar for resizing
cv2.createTrackbar("Size", "Resizable 3D Image", cube_size, 200, on_size_change)
